...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--model', type=str, default='pix2pixHDs2', help='which model to use')
        ...
        self.parser.add_argument('--loadhSize', type=int, default=1024, help='scale images to this size')
        self.parser.add_argument('--loadwSize', type=int, default=1024, help='scale images to this size')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='./datasets/AOI/') 
